...
commits, code, wiki edits, issues, pull requests, and other contributions that
are not aligned to this Code of Conduct. They may temporarily or permanently ban
...
representing the project include using an official email address, posting through
...
reported to the maintainers by opening a GitHub issue that asks for a private
maintainer contact. Do not include sensitive personal details in a public issue.
...
Consequence: a warning with consequences for continued behavior. The person may
be asked not to interact with the people involved, including unsolicited
